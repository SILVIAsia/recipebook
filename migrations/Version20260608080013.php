 ...
 */
final class Version20260608080013 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recette ADD category_id INT DEFAULT NULL, CHANGE titre titre VARCHAR(180) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recette DROP category_id, CHANGE titre titre VARCHAR(255) NOT NULL');
    }
}
