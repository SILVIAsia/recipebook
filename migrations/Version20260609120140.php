 ...
 */
final class Version20260609120140 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ingredient CHANGE name name VARCHAR(50) DEFAULT NULL, CHANGE quantity quantity DOUBLE PRECISION DEFAULT NULL, CHANGE unit unit VARCHAR(10) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE step CHANGE number number INT DEFAULT NULL, CHANGE description description LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ingredient CHANGE name name VARCHAR(50) NOT NULL, CHANGE quantity quantity DOUBLE PRECISION NOT NULL, CHANGE unit unit VARCHAR(50) NOT NULL');
        ...
        $this->addSql('ALTER TABLE step CHANGE number number INT NOT NULL, CHANGE description description LONGTEXT NOT NULL');
    }
}
