 ...
 */
final class Version20260608095755 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recette ADD place_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_49BB6390DA6A219 ON recette (place_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_49BB6390DA6A219 ON recette');
        $this->addSql('ALTER TABLE recette DROP place_id');
