 ...
 */
final class Version20260612220639 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recette CHANGE picture picture VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recette CHANGE picture picture VARCHAR(50) DEFAULT NULL');
